...
#   ])
  ...
  User.create(name: "Kevin", username: "reynin14")
  User.create(name: "Eugene", username: "ginodibo")

  Movie.create(title: "Batman", trailer_url: "google.com")
  Movie.create(title: "Superman", trailer_url: "facebook.com")

  UserMovie.create(user_id: 1, movie_id: 1)
  UserMovie.create(user_id: 1, movie_id: 2)
  UserMovie.create(user_id: 2, movie_id: 2)
